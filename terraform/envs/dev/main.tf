...
# Create a route table for private subnets (optional for internal routing)
    ...
    Statement = [
      {
        Effect = "Allow"
        Principal = {
          Federated = "arn:aws:iam::329599632576:oidc-provider/token.actions.githubusercontent.com"  
        }
